...
scienceButton.addEventListener("click", function() {
    ...
    let sciInput = document.querySelector(".science").value;
    ...
    if (sciInput === "solid") {
        ...
        document.querySelector(".science-message").innerHTML = "Sad. Try agiain."
...
// Finish Early?
//  - When a student gets the answer right, make it so their answer turns green. <check>
//  - If they get it wrong, make their answer turn red. <check>
